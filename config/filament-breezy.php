...
return [
    ...
    */
    "password_confirmation_seconds" => config('auth.password_timeout', 300),
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Path to Profile page component. \JeffGreco13\FilamentBreezy\Pages\MyProfile::class
    */
